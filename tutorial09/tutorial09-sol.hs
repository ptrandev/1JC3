...
-- functions are data in Haskell, can be treated just like data of any other time
...
-- Many functions take in other functions as arguments: map, filter, foldr, foldl
...
-- The identity function, the most basic combinator
id' :: a -> a
id' x = x

-- consider the following properties...
-- map id xs == xs -- mapping the identity over a list is the same as the list
-- f . id == id . f -- the identity function is the identity for function composition
-- f . id == f -- the identity function is the identity for function composition
...
-- it takes a function and applies it to an argument on the right
